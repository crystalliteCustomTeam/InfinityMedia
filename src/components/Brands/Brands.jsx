        ...
        <section className='py-[50px] lg:py-[80px]'>
            <div className="container">
                ...
                <div className="grid grid-cols-12 items-center">
                    ...
                    <div className="col-span-12 md:col-span-6">
                        <Image src={BrandThree} alt='Infinity Media Inc' className='w-9/12 mx-auto md:block hidden animation' />
                    </div>
                </div>
                <div className="grid grid-cols-12 items-center my-14">
                    <div className="col-span-12 md:col-span-6">
                        <Image src={BrandFour} alt='Infinity Media Inc' className='w-9/12 md:block hidden animationUpDown' />
                    </div>
                    <div className="col-span-12 md:col-span-6">
                        ...
                        <p className='font-sans text-white text-[14px] lg:text-[16px] mt-3 mb-8 lg:pr-5 h-[100px] overflow-y-scroll lg:overflow-y-hidden lg:h-full'>SEO Results Pro, a prominent offering by Infinity Media Inc, is a results-driven digital marketing agency. Our specialized search engine optimization (SEO) services boost your online presence, drive organic traffic, and generate valuable leads. With a team of experienced professionals and advanced strategies, we optimize your website’s visibility, improve search engine rankings, and help you stand out in the highly competitive digital landscape.</p>
                ...
                <div className="grid grid-cols-12 items-center">
                    ...
                    <div className="col-span-12 md:col-span-6">
                        <Image src={BrandFive} alt='Infinity Media Inc' className='w-9/12 mx-auto md:block hidden animation' />
                    </div>
                </div>
                <div className="grid grid-cols-12 items-center my-14">
                    <div className="col-span-12 md:col-span-6">
                        <Image src={BrandSix} alt='Infinity Media Inc' className='w-9/12 md:block hidden animationUpDown' />
                    </div>
                    <div className="col-span-12 md:col-span-6">
                ...
                <div className="grid grid-cols-12 items-center">
                    ...
                    <div className="col-span-12 md:col-span-6">
                        <Image src={BrandSeven} alt='Infinity Media Inc' className='w-9/12 mx-auto md:block hidden animation' />
                    </div>
                </div>
                <div className="grid grid-cols-12 items-center mt-14 lg:mb-14">
                    <div className="col-span-12 md:col-span-6">
                        <Image src={BrandEight} alt='Infinity Media Inc' className='w-9/12 md:block hidden animationUpDown' />
                    </div>
                    <div className="col-span-12 md:col-span-6">
